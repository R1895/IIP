    ...
    return function (t) {
        ...
        e.default = {
            props: {
                ...
                easingFn: {
                    type: Function, default: function (t, e, i, n) {
                ...
                start: function () {
                    ...
                    var e = t.split("."), i = e[0], n = e.length > 1 ? this.decimal + e[1] : "", a = /(\d+)(\d{3})/;
                    if (this.separator && !this.isNumber(this.separator)) for (; a.test(i);) i = i.replace(a, "$1" + this.separator + "$2");
        ...
        if ("undefined" == typeof window) e.requestAnimationFrame = r = function () {
            ...
            r && o || (e.requestAnimationFrame = r = function (t) {
                var e = (new Date).getTime(), i = Math.max(0, 16 - (e - n)), a = window.setTimeout(function () {
                    t(e + i)
                }, i);
                return n = e + i, a
